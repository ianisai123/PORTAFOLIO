const galleries = {
  service: [
    "img/ServiceDesk/Login.png",
    "img/ServiceDesk/pantallaTicket.png",
    "img/ServiceDesk/pantallaTicketResuelto.png",
    "img/ServiceDesk/detalleTicket.png",
    "img/ServiceDesk/PrioridadTickets.png",
    "img/ServiceDesk/EstadoTicket.png",
    "img/ServiceDesk/reporte.png",
    "img/ServiceDesk/CorreoTicket.png",
    "img/ServiceDesk/CorreoTicketResuelto.png",
    "img/ServiceDesk/chat.png",
    "img/ServiceDesk/Menu.png",
    "img/ServiceDesk/ReporteExcel.png",
    "img/ServiceDesk/VaciarBD.png",
    "img/ServiceDesk/AgregarUsuario.png",
    "img/ServiceDesk/EliminarUsuario.png",
    "img/ServiceDesk/Configuracion.png",
  ],

  kiosk: [
    "img/Kiosko/Login.png",
    "img/Kiosko/InicioEmpleado.png",
    "img/Kiosko/Formatos.png",
    "img/Kiosko/SolicitudesEmpleados.png",
    "img/Kiosko/SolicitudesJefe.png",
    "img/Kiosko/subordinados.png",
    "img/Kiosko/Confirmar.png",
    "img/Kiosko/VerFormato.png",
    "img/Kiosko/InicioAdmin.png",
    "img/Kiosko/AgregarUsuario.png",
    "img/Kiosko/BuscarEmpleado.png",
    "img/Kiosko/EditarEmpleado.png",
    "img/Kiosko/SolitudesPendientes.png"
  ],
  expenses: [
    "img/App/gastos-placeholder.svg"
  ]
};
